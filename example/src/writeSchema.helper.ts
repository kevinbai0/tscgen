...
import { IImportBuilder, IType, mapObject } from '../../src/lib';
import { Promiseable } from '../../src/lib/helpers/promise';
  ...
  return handleRef(obj, {
    ...
    notRef: async (
      ...
      if (obj.type === 'object' || obj.properties) {
        ...
        return {
          type: tscgen.objectType(mapObject(withSchema, (val) => val.type)),
